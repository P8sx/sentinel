...
static const unsigned char image_gate_close_left_21x21_bits[] U8X8_PROGMEM = {0x00,0x00,0x1c,0x00,0x70,0x1c,0xc0,0x71,0x1c,0xc0,0x71,0x1c,0xc0,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xff,0xff,0x1f,0xff,0xff,0x1f,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xff,0xff,0x1f,0xff,0xff,0x1f,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c};
static const unsigned char image_gate_open_left_9x19_bits[] U8X8_PROGMEM = {0xc0,0x01,0xc0,0x01,0xc0,0x01,0xc0,0x01,0xc7,0x01,0xc7,0x01,0xc7,0x01,0xff,0x01,0xff,0x01,0xc7,0x01,0xc7,0x01,0xc7,0x01,0xc7,0x01,0xc7,0x01,0xc7,0x01,0xff,0x01,0xff,0x01,0xc7,0x01,0xc7,0x01};

static const unsigned char image_gate_close_right_21x21_bits[] U8X8_PROGMEM = {0x07,0x00,0x00,0xc7,0x01,0x00,0xc7,0x71,0x00,0xc7,0x71,0x00,0xc7,0x71,0x00,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xff,0xff,0x1f,0xff,0xff,0x1f,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xff,0xff,0x1f,0xff,0xff,0x1f,0xc7,0x71,0x1c,0xc7,0x71,0x1c,0xc7,0x71,0x1c};
...
void i2c_oled_home_screen(uint8_t screen_saver_time, float soc_temp, bool wifi_status, gate_state_t m1_state, gate_state_t m2_state, bool animation_toggle){
	if(!i2c_oled_init) return;
	...
	uint8_t m1_str_len = u8g2_GetStrWidth(&u8g2, STATE_STRING_NORMALIZED(m1_state));
	uint8_t m2_str_len = u8g2_GetStrWidth(&u8g2, STATE_STRING_NORMALIZED(m2_state));

	u8g2_DrawStr(&u8g2,32-(m1_str_len/2) ,27, STATE_STRING_NORMALIZED(m1_state));
	u8g2_DrawStr(&u8g2,96-(m2_str_len/2) ,27, STATE_STRING_NORMALIZED(m2_state));
	...
	switch(m1_state){
		...
		case CLOSING:
			...
			break;
		case OPENED:
			u8g2_DrawXBMP(&u8g2 ,32-5, 33, 9, 19, image_gate_open_left_9x19_bits);
			break;
		case CLOSED:
			u8g2_DrawXBMP(&u8g2 ,32-10, 33, 21, 21, image_gate_close_left_21x21_bits);
			break;
		default:
			u8g2_DrawXBMP(&u8g2 ,32-2, 33, 4, 16, image_gate_unknonw_8_4x16_bits);
			break;
	}
	switch(m2_state){
		case OPENING:
		case CLOSING:
			...
			break;
		case OPENED:
			u8g2_DrawXBMP(&u8g2 ,96-5, 33, 9, 19, image_gate_open_right_9x19_bits);
			break;
		case CLOSED:
			u8g2_DrawXBMP(&u8g2 ,96-10, 33, 21, 21, image_gate_close_right_21x21_bits);
			break;
		default:
			u8g2_DrawXBMP(&u8g2 ,96-2, 33, 4, 16, image_gate_unknonw_8_4x16_bits);
			break;
	}
